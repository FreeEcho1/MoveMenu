...
public class MonitorInformation
{
    ...
    /// 指定領域があるモニター情報を取得
    /// </summary>
    /// <param name="specifiedAreaRectangle">指定領域の位置</param>
    /// <param name="monitorInfo">MonitorInfoEx</param>
    /// <returns>結果 (どのディスプレイにも入っていない「false」/どれかのディスプレイに入っている「true」)</returns>
        ...
        )
    {
        ...
        foreach (MonitorInfoEx nowMonitorInfo in PluginData.MonitorInformation.MonitorInfo)
        {
